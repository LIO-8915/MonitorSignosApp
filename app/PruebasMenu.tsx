...
export default function PruebasMenu() {
  ...
  const rutasPruebas: [number, string, string, string, string][] = [
    ...
    [18, '/Prueba18OARSScreen', 'Prueba 18 OARSS', 'people', '#9C27B0'],
    [15, '/Prueba15MNA-SF', 'Nutrición (MNA-SF)', 'restaurant', '#4CAF50'],
    [13, '/Prueba13Auditiva', 'Capacidad Auditiva', 'ear', '#00BCD4'],
    [12, '/Prueba12Norton', 'Escala (Norton)', 'body', '#FF9800'],
    [11, '/Prueba11Braden', 'Escala (Braden)', 'shield', '#FF5722'],
    [8, '/Prueba8Lawton', 'Act. Instrumentales (Lawton)', 'construct', '#795548'],
